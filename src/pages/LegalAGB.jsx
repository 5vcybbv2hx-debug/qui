...
import { fillLegalTemplate, AGB_TEMPLATE } from '@/lib/legalContent';
import { Card, CardContent } from '@/components/ui/card';

export default function LegalAGB() {
  ...
  const filledText = fillLegalTemplate(AGB_TEMPLATE, companyInfo);
  ...
  return (
    <div className="min-h-screen bg-background pb-6">
      ...
      <div className="sticky top-0 z-40 bg-card border-b border-border px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-foreground">AGB</h1>
      </div>
